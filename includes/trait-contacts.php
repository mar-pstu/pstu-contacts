...
trait Contacts {
	 ...
	 * @access   public
	 */
	public function get_contacts_meta_keys() {
		return array(
			new SettingsSection( 'scientometrics', __( 'Наукометрика', $this->plugin_name ), array(
				new Field( 'orcid_id', __( 'ORCID iD', $this->plugin_name ), '' ),
				new Field( 'google_scholar', __( 'Google Schola', $this->plugin_name ), '' ),
				new Field( 'researcher_id', __( 'Researcher iD', $this->plugin_name ), '' ),
				new Field( 'scopus_id', __( 'Scopus iD', $this->plugin_name ), '' ),
				new Field( 'research_gate_id', __( 'ResearchGate iD', $this->plugin_name ), '' ),
				new Field( 'pstu_eir', __( 'Электронный репозитoрий НТБ ПГТУ', $this->plugin_name ), '' ),
			) ),
			new SettingsSection( 'contacts', __( 'Контактная информация', $this->plugin_name ), array(
				...
				new Field( 'schedule_admission', __( 'График приёма', $this->plugin_name ), '' ),
			) ),
			new SettingsSection( 'socials', __( 'Профили социальных сетей', $this->plugin_name ), array(
				new Field( 'google_plus', __( 'Google Plus', $this->plugin_name ), '' ),
