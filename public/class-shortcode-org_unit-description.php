 ...
 */
class PublicShortcodeOrgUnitDescription extends Shortcode {
	...
	public function manager( $atts ) {
		...
		if ( ( bool ) $atts[ 'id' ] ) {
			...
			if ( ! empty( $html ) ) {
				$html = sprintf(
					'<div class="org-unit-entry"><p class="org-unit-entry-title"><strong><a href="%1$s">%2$s</a></strong></p> %3$s</div>',
