( function( blocks, editor, i18n, element, components, _ ) {
	...
	function set_shortcode( props, id, contact_template ) {
		var shortcode = '[pstu_org_unit_leader id="' + id + '" contact_template="' + contact_template + '" ]';
		props.setAttributes( { shortcode: shortcode } );
	}


	blocks.registerBlockType( 'pstu-contacts/org-unit-leader', {
		title: i18n.__( 'Руководитель подразделения', plugin_name ),
		...
		keywords: [
			...
			i18n.__( 'руководитель', plugin_name ),
		],
